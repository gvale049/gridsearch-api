...
},{"regenerator-runtime":"QVnC"}],"fcMS":[function(require,module,exports) {
  ...
  (0, _createClass2.default)(Grid, [{
    ...
    value: function renderGrid(gridSize, wordGrid) {
      ...
      tbl.addEventListener("mouseup", function (event) {
        ...
        var sellectedWord = _this.selectedItems.reduce(function (word, cell) {
          return word += cell.getAttribute("data-letter");
        }, '');

        var reverseSelectedWord = sellectedWord.split("").reverse().join("");

        if (_this.words.indexOf(sellectedWord) !== -1) {
          _this.foundWords.push(sellectedWord);
...
submitWordBtn.addEventListener("click", /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
  var grid, commaSeparetedWords, gridSize, result, wordListNode, wordListSection;
  return _regenerator.default.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          grid = new _grid.Grid();
          commaSeparetedWords = document.querySelector("#add-word").value;
          gridSize = document.querySelector("#grid-size").value;
          _context.next = 5;
          return fetchGridInfo(gridSize, commaSeparetedWords);

        case 5:
          result = _context.sent;
          grid.words = commaSeparetedWords.split(",");
...
function _fetchGridInfo() {
  _fetchGridInfo = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(gridSize, commaSeparetedWords) {
    var response, result;
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch("http://localhost:8080/wordgrid?gridSize=".concat(gridSize, "&wordList=").concat(commaSeparetedWords));
...
},{"@babel/runtime/helpers/asyncToGenerator":"agGE","@babel/runtime/regenerator":"PMvg","./grid":"mwQg"}]},{},["QvaY"], null)
//# sourceMappingURL=/js.cf2863bf.js.map